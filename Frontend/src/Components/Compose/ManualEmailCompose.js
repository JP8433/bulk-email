...
export function ManualEmailCompose({reUse}) {
  ...
  return (
    <div
      className="d-flex justify-content-center align-items-center m-4 composestyle" style={{backgroundColor: "#D3D3D3 "}}>
      <div className="" style={{ width: "100%", height: "800px" }}>
        <h1>Compose Email</h1>
        <hr />
        ...
        <Form.Group controlId="formField " className="mb-3">
          <Form.Label className="text-start w-100">
            Recipient (Only select Excel file below)
          </Form.Label>
          <InputGroup>
          <Form.Control
            type="text"
