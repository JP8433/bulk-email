...
const Compose = () => {
  ...
  return (
    <div className="d-flex justify-content-center align-items-center flex-column "style={{backgroundColor: "#D3D3D3 "}}>
      <div className="d-flex m-4 ms-5 container-lg " style={{ width: "100%" ,backgroundColor: "#D3D3D3 "}}>
        <ButtonGroup>
      ...
      {radioValue === "manual" ? (
        ...
        >
          ...
          <ExcelExampleModal />
          <div className="" style={{ width: "1000px", height: "800px" }}>
            <h1>compose</h1>
            <hr />
